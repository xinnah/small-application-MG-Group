...
$(".addmore").on('click',function(){
	...
	html += '<td><input type="text" data-type="uom_name" name="uom_name[]" id="uom_'+i+'" class="form-control autocomplete_txt" autocomplete="off" ></td>';

	html += '<td><input type="number" min="0" name="product_price_amount[]" step="0.01" id="hidden_'+i+'" class="form-control changesNo" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" readonly="readonly"></td>';

	html += '<td><input type="number" min="0" name="avaliable_qty[]" step="0.01" id="quantity_'+i+'" class="form-control changesNo" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" readonly="readonly"></td>';

	html += '<td><input type="number" min="0" name="sales_qty[]" step="0.01" id="quantity2_'+i+'" class="form-control changesNo" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;"></td>';

	html += '<td><input type="number" min="0" step="0.01" name="product_wise_discount[]" id="benefit_'+i+'" class="form-control changesNo benefit" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;"></td>';

	html += '<td><input type="number" min="0" step="0.01" name="product_paid_amount[]" id="total_'+i+'" class="form-control totalLinePrice" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;"readonly="readonly"><input type="hidden" step="0.01" min="0" name="price[]" id="cost_'+i+'" class="form-control changesNo" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" ></td>';
...
function calculateBenefit(){
	...
	price = $("#hidden_"+id[1]).val();
    parsentWise = parseFloat(price)/100*parseFloat(benefit);
    salesAmount = parseFloat(price)-parseFloat(parsentWise);
    console.log(price);
    $("#cost_"+id[1]).val(salesAmount);
