@extends('layout.app')
	...
	<div id="content" class="content">
		...
		<ol class="breadcrumb pull-right">
			<li><a class="btn btn-info" href="{{URL::to('/product-category/create')}}">Add New Category</a></li>
		</ol>
		<!-- end breadcrumb -->
		<!-- begin page-header -->
                                    ...
                                    <!-- edit section -->
                                        ...
                                        <div class="modal fade" id="modal-dialog<?php echo $category->id;?>">
                                            <div class="modal-dialog">
                                                ...
                                                {!! Form::open(array('route' => ['product-category.update',$category->id],'class'=>'form-horizontal author_form','method'=>'PUT','files'=>'true', 'id'=>'commentForm','role'=>'form','data-parsley-validate novalidate')) !!}
                                        ...
                                        <!-- delete section -->
                                        {!! Form::open(array('route'=> ['product-category.destroy',$category->id],'method'=>'DELETE')) !!}
